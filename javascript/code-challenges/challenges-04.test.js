...
------------------------------------------------------------------------------------------------ */
// const names = ['Cat', 'apple', 'Dog', 'banana'];
...
------------------------------------------------------------------------------------------------ */
const inputArray = ['Alphabet', 'Zebra', 'alphabet', 'carrot'];
...
const sortNumbersByLength = (arr) => {
  return arr.sort((a, b) => {
    ...
    const bLength = Math.abs(b).toString().length;
...
const sortPeopleBetter = (arr) => {
  arr.sort((person1, person2) => {
    ...
    if (lastNameComparison === 0) {
      const firstNameComparison = person1.firstName.localeCompare(person2.firstName);
...
//   arr.sort((meeting1, meeting2) => {
//     const dayIndex1 = daysOfWeek.indexOf(meeting1.dayOfWeek);
//     const dayIndex2 = daysOfWeek.indexOf(meeting2.dayOfWeek);

//     if (dayIndex1 < dayIndex2) {
//       return -1;
//     } else if (dayIndex1 > dayIndex2) {
//       return 1;
//     } else {
//       return meeting1.start.localeCompare(meeting2.start);
//     }
//   });
// };
...
const sortMeetingsByDay = (arr) => {
  ...
  days.forEach(day => {
    sortedMeetings.push(...meetingsByDay[day]);
  });
