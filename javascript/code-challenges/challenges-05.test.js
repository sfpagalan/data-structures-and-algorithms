...
const extractStats = (snorlaxData) => {
  return snorlaxData.stats.reduce((statsObject, statData) => {
    statsObject[statData.stat.name] = statData.baseStat;
    return statsObject;
  }, {});
};
...
const extractChildren = (arr) => {
  ...
  const childrenArray = filteredCharacters.reduce((children, character) => {
    if (character.children) {
